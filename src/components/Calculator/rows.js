export const rows = [
    [{ flex: 1, buttonContent: 'AC', position: 'top' }, { flex: 1, buttonContent: '+/-', position: 'top' }, { flex: 1, buttonContent: '%', position: 'top' }, { flex: 1, buttonContent: '÷', position: 'right' }],
    ...
    [{ flex: 2, buttonContent: '0', position: 'center' }, { flex: 1, buttonContent: '.', position: 'center' }, { flex: 1, buttonContent: '=', position: 'right' }],
];